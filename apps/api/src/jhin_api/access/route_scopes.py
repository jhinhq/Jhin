...
ROUTE_SCOPES: dict[tuple[str, ...], RouteRule] = {
    ...
    ("personas",): _rule("personas:read", "personas:write"),
    ("personas", "install-builtins"): _rule(None, "personas:write"),
    ("personas", "enable"): _rule(None, "personas:write"),
    ("personas", "disable"): _rule(None, "personas:write"),
    ("personas", "duplicate"): _rule(None, "personas:write"),
