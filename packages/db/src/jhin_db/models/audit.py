...
from jhin_db.columns import CreatedAtMixin, JsonDict, UuidPkMixin
...
class AuditEvent(Base, UuidPkMixin, CreatedAtMixin):
    ...
    workspace_id: Mapped[UUID | None] = mapped_column(Uuid, default=None)
    ...
    request_id: Mapped[UUID | None] = mapped_column(Uuid, default=None)
